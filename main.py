...
"""Entry point for PoE2 Rumor Counter.
...
class MainApplication(QMainWindow):
    ...
    # Signal emitted internally when the hotkey fires.
    ...
    def __init__(self):
        ...
        # UI Setup
        self.setWindowTitle("PoE2 Rumor Counter")
    ...
    def _init_ui(self):
        ...
        self.toggle_session_btn = QPushButton("Stop")
    ...
    def on_session_start(self):
        ...
        self.toggle_session_btn.setText("Stop")
        self.toggle_session_btn.setEnabled(True)
        self.last_rumor_label.setText("Сканирование активно...")

    def on_session_stop(self):
        """Called when scanning stops."""
        self.scanner_worker.stop()
        self.toggle_session_btn.setText("Start")
        self.toggle_session_btn.setEnabled(True)
        self.counter_label.setStyleSheet("""
            QLabel {
                font-size: 48px;
